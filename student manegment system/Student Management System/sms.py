...
def connect_database():
    ...
    hostnameLabel=Label(connectWindow,text='Host Name',font=('Tahoma',20,'bold'))
    hostnameLabel.grid(row=0,column=0,padx=20)

    hostEntry=Entry(connectWindow,font=('roman',15,'bold'),bd=2)
    hostEntry.grid(row=0,column=1,padx=40,pady=20)

    usernameLabel = Label(connectWindow, text='User Name', font=('Tahoma', 20, 'bold'))
    usernameLabel.grid(row=1, column=0, padx=20)

    usernameEntry = Entry(connectWindow, font=('roman', 15, 'bold'), bd=2)
    usernameEntry.grid(row=1, column=1, padx=40, pady=20)

    passwordLabel = Label(connectWindow, text='Password', font=('Tahoma', 20, 'bold'))
...
sliderLabel=Label(root,font=('Tahoma',28,'italic bold'),width=30)
...
logo_image=PhotoImage(file="C:\\Users\\shekahe\\OneDrive - Tecnotree\\Desktop\\student manegment system\\Student Management System\\student.png")
